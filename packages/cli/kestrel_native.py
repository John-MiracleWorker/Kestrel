...
from kestrel_cli import native_skillpacks as _native_skillpacks
...
globals().update({name: value for name, value in vars(_native_skillpacks).items() if not name.startswith("__")})
