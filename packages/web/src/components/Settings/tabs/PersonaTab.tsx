...
export function PersonaTab({ systemPrompt, setSystemPrompt }: PersonaTabProps) {
    return (
        <div>
            ...
            >
                Define Kestrel's personality, instructions, and behavior. Leave empty for the
                default autonomous agent persona.
            </p>
            <div style={S.field}>
                <textarea
                    style={S.textarea}
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '6px' }}>
                    ...
                    {systemPrompt && (
                        <button
                            style={{ ...S.btnGhost, padding: '4px 10px', fontSize: '0.7rem' }}
