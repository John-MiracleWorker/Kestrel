...
export function ToolsTab({
    ...
    return (
        <div>
            ...
            >
                Manage the tools Kestrel can use. Disable tools to restrict capabilities. Kestrel
                can also create new tools on the fly (with your approval).
            </p>
            ...
            >
                ...
                <button
                    style={{ ...S.btnGhost, padding: '6px 14px', fontSize: '0.7rem' }}
            ...
            {showCreateTool && (
                ...
                >
                    ...
                    <div style={S.field}>
                        ...
                        <textarea
                            style={{ ...S.textarea, minHeight: 120, fontSize: '0.75rem' }}
                            value={newToolCode}
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                            ...
                            onClick={async () => {
                                ...
                                try {
                                    const goalParts = [
                                        `Create a new Python skill/tool named "${newToolName}"`,
                                    ];
                                    ...
                                    setNewToolCode('');
                                    setSaveStatus(
                                        'Tool creation task dispatched — check Tasks panel',
                                    );
            ...
            <div style={{ marginTop: '32px', borderTop: '1px solid #1a1a1a', paddingTop: '24px' }}>
                ...
                >
                    Connect external MCP (Model Context Protocol) servers to give Kestrel new
                    capabilities. Servers can provide file access, database queries, API
                ...
                <div style={{ marginBottom: '16px' }}>
                    <div style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
                        <input
                            style={{
                                ...S.input,
                                flex: 1,
                                borderColor: mcpSearching ? '#a855f7' : '#333',
                            }}
                                ...
                                if (e.key === 'Enter' && mcpSearchQuery.trim()) {
                                    ...
                                    try {
                                        const d = (await request(
                                            `/mcp/search?q=${encodeURIComponent(mcpSearchQuery)}`,
                                        )) as {
                                            results?: Array<{
                                                name: string;
                                                description: string;
                            ...
                            onBlur={(e) => {
                                if (!mcpSearching) e.target.style.borderColor = '#333';
                            }}
                        />
                        <button
                            style={{
                    ...
                    >
                        <span style={{ fontSize: '0.65rem', color: '#555' }}>
                            Searches official MCP catalog + Smithery registry
                        </span>
                        <a
                                                ...
                                                >
                                                    <button
                                                        style={{
                                                            ...
                                                            fontSize: '0.7rem',
                                                            background: '#a855f7',
                                                            opacity: r.requires_env.every((k) =>
                                                                mcpEnvValues[k]?.trim(),
                                                            )
                                                                ? 1
                                                                : 0.4,
                ...
                {mcpLoading ? (
                            ...
                            >
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    ...
                                    >
                                        ...
                                        {srv.installed_at &&
                                            ` · Added ${new Date(srv.installed_at).toLocaleDateString()}`}
                                    </div>
                                </div>
                                <button
                                    style={{
                                    ...
                                    onClick={async () => {
                                        try {
                                            await request(
                                                `/workspaces/${workspaceId}/mcp-tools/${srv.name}`,
                                                { method: 'DELETE' },
                                            );
                                            setMcpServers((prev) =>
                                                prev.filter((s) => s.name !== srv.name),
                                            );
                                        } catch {
                                            /* ignore */
                                        }
                    ...
                    >
                        No MCP servers connected. Add one above or let Kestrel discover servers
                        automatically.
                    </div>
                )}
            </div>
