...
export function AutomationTab({
    ...
    return (
        <div>
            ...
            >
                Allow Kestrel to wake up automatically on a schedule to perform routine tasks,
                checks, and cleanups in this workspace.
            </p>
                ...
                >
                    <div style={S.field}>
                        ...
                        <div style={{ fontSize: '0.65rem', color: '#555', marginTop: '6px' }}>
                            Standard cron syntax (e.g. <code>0 9 * * 1-5</code> for weekdays at
                            9am). Defaults to <code>0 * * * *</code> (every hour).
                        </div>
                    </div>

                    <SliderField
                        label="Max Consecutive Runs"
                        value={cronMaxRuns}
                        onChange={(v) => setCronMaxRuns(Math.round(v))}
                        min={1}
                        max={10}
                        step={1}
                        format={(v) => `${v} runs`}
                    ...
                    <div style={{ ...S.field, marginBottom: 0 }}>
                        ...
                        <textarea
                            ...
                            value={cronSystemPrompt}
                            onChange={(e) => setCronSystemPrompt(e.target.value)}
