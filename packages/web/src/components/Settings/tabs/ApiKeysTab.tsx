...
export function ApiKeysTab({ workspaceId }: ApiKeysTabProps) {
    ...
    const [newKeyRole, setNewKeyRole] = useState<ApiKey['role']>('member');
    ...
    const handleCreateKey = async () => {
        ...
        try {
            const data = await keysApi.create(workspaceId, newKeyName, { role: newKeyRole });
            setCreatedKey(data);
            setNewKeyName('');
    ...
    const handleRevokeKey = async (keyId: string) => {
        try {
            await keysApi.revoke(workspaceId, keyId);
    ...
    return (
        <div>
            ...
            >
                Access this workspace programmatically. Keys are scoped to the current workspace and
            ...
            {createdKey && (
                <div style={S.successBox}>
                    ...
                    <div style={{ fontSize: '0.7rem', marginBottom: '8px', opacity: 0.8 }}>
            ...
            <div style={{ display: 'flex', gap: '8px', marginBottom: '20px' }}>
                ...
                <button style={S.btnPrimary} onClick={handleCreateKey}>
                    + Create
                </button>
            </div>
