    ...
    const reviewPR = async (prNumber: number) => {
        ...
        try {
            const result = await request<{ review: ReviewResult; pr: PRInfo }>(
                ...
                {
                    method: 'POST',
                    body: { owner: activeRepo.owner, repo: activeRepo.repo, prNumber },
                },
            );
            ...
            <div style={S.sidebar}>
                ...
                <div style={S.repoList}>
                    {repos.length === 0 && (
                        ...
                        >
                            No repos connected yet. Add one below.
                        </div>
                    )}
                    {repos.map((r) => (
                        <div
                ...
                <div style={S.addRepoForm}>
                    ...
                    />
                    <button style={S.addBtn} onClick={addRepo}>
                        + Add Repo
                    </button>
                </div>
            </div>
                    ...
                    <div style={S.prListBar}>
                        {loadingPRs ? (
                            ...
                            prList.map((pr) => (
                                <div
                                    key={pr.number}
                                    style={S.prPill(selectedPR === pr.number)}
                ...
                <div style={S.body}>
                    ...
                    {!activeRepo && (
                        <div style={S.emptyState}>
                            ...
                            >
                                Add a GitHub repo in the sidebar (e.g.{' '}
                                <span style={{ color: '#10b981' }}>owner/repo</span>) to browse and
                        ...
                        <>
                            <div style={S.prMeta}>
                                ...
                                <div style={S.metaStat}>
                                    ...
                                    <span style={{ ...S.metaValue, fontSize: '0.7rem' }}>
                                        {prInfo.title}
                                    </span>
                                </div>
                                <div style={S.metaStat}>
                            ...
                            <div style={S.section}>
                                {verdictInfo && (
                                    <div style={S.verdictBadge(verdictInfo.color)}>
                                        {verdictInfo.icon} {verdictInfo.label} — Score:{' '}
                                        {review.score}/10
                                    </div>
                                )}
                                <div
                                    ...
                                    {review.issues.map((issue, i) => (
                                        <div key={i} style={S.issueCard(issue.severity)}>
                                            <div style={S.issueTitle}>
                                                <span style={S.issueSeverity(issue.severity)}>
                                                    {issue.severity}
                                                </span>
