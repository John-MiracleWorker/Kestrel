...
export default async function automationRoutes(app: FastifyInstance, deps: AutomationDeps) {
    ...
    typedApp.post(
        '/api/workspaces/:workspaceId/automation/cron/parse',
        {
    ...
    // Create a cron job
    typedApp.post(
        '/api/workspaces/:workspaceId/automation/cron',
        {
            preHandler: [requireAuth, requireWorkspace],
        ...
        async (req, reply) => {
            const user = req.user!;
            const { workspaceId } = req.params as WorkspaceParams;
            const { name, description, cronExpression, goal, maxRuns } =
                req.body as CreateCronJobBody;
    ...
    // Delete a cron job
    typedApp.delete(
        '/api/workspaces/:workspaceId/automation/cron/:jobId',
        {
            preHandler: [requireAuth, requireWorkspace],
    ...
    typedApp.post(
        '/api/workspaces/:workspaceId/automation/webhooks',
        {
            preHandler: [requireAuth, requireWorkspace],
    ...
    // Delete a webhook
    typedApp.delete(
        '/api/workspaces/:workspaceId/automation/webhooks/:webhookId',
        {
            preHandler: [requireAuth, requireWorkspace],
            ...
            try {
                const result = await brainClient.triggerWebhook({
                    ...
                    headers: {
                        ...
                        'x-signature-256':
                            headers['x-signature-256'] || headers['x-hub-signature-256'] || '',
    ...
    // Launch a workflow
    typedApp.post(
        '/api/workspaces/:workspaceId/workflows/:workflowId/launch',
        {
            preHandler: [requireAuth, requireWorkspace],
    ...
    typedApp.post(
        '/api/workspaces/:workspaceId/capabilities/:capId/install',
        {
            preHandler: [requireAuth, requireWorkspace],
    ...
    typedApp.patch(
        '/api/workspaces/:workspaceId/capabilities/:capId',
        {
            preHandler: [requireAuth, requireWorkspace],
            schema: {
