...
- A metadata consistency check that keeps the unreleased development package, private web package, published stable installer, security support line, and changelog base aligned.
