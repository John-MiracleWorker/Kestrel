...
`v0.4.0` is the current stable release for the supported local/private deployment profile. This
...
use the published `linux/arm64` container image for `v0.4.0` and later. The `v0.4.0`
