...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "function": {
            "name": "music_control",
            "description": "Control Apple Music and analyze listening habits. Use for playback (play/pause/skip), searching the local library, searching the Apple Music catalog, creating playlists, and getting listening stats. Use 'search_catalog' to open Apple Music's full catalog search when the user wants to discover new music beyond their library.",
            "parameters": {
                "type": "object",
                "properties": {
                    "action": {
                        "type": "string",
                        "enum": ["play", "pause", "next", "previous", "now_playing", "search", "search_catalog", "create_playlist", "add_to_playlist", "listening_stats", "recent_history"],
                        "description": "The music action to perform. 'search' searches the local library; 'search_catalog' opens Apple Music's full catalog search.",
                    },
                    "query": {
                        "type": "string",
                        "description": "Search query for 'search'/'search_catalog', or playlist name for 'create_playlist'/'add_to_playlist'",
                    },
                    "track_name": {
                        "type": "string",
...
tell application "Music"
    ...
    return results
        ...
        # ── Search Apple Music Catalog ────────────────────────
            ...
            time.sleep(2)  # Let Apple Music load results
            return {
                "status": "ok",
                "action": "search_catalog",
                "query": query,
                "next_steps": "IMMEDIATELY call read_screen to see the Apple Music search results. Then pick the best matching track and call music_control(action='play', query='exact track name') to play it. DO NOT ask the user to choose — just pick the best one and play it.",
            }
