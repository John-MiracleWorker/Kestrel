    ...
    def from_mapping(cls, raw: Mapping[str, Any]) -> TurnSource:
        ...
        return cls(
            **required,
            ...
            message_id=_optional_source_string(
                raw.get("message_id"), field_name="message_id"
            ),
...
def durable_channel_session_id(
    *, channel: str, channel_id: str, conversation_id: str
) -> str:
    ...
    if _legacy_session_part_is_lossless(
        channel_id
    ) and _legacy_session_part_is_lossless(conversation_id):
        return legacy_id
