...
def handle_request(request):
    ...
    if method == 'initialize':
        return {
            ...
            "capabilities": {
                "tools": {
                    "gmail_list_messages": {"description": "List Gmail messages"},
                    "gmail_get_message": {"description": "Get a specific Gmail message"},
                    "gmail_send_message": {"description": "Send a Gmail message"}
                }
            },
