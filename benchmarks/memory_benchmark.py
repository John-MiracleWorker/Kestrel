"""Comparative memory retrieval benchmark: Kestrel layered memory vs flat TF-IDF RAG.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Kestrel vs baseline RAG memory benchmark.")
